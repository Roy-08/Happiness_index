    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🚀', text: 'Une histoire qui avance dans la bonne direction', subtext: 'A story moving in the right direction', points: 4 },
          { emoji: '🧩', text: 'Une histoire qui perd constamment son intrigue', subtext: 'A story that keeps losing its plot', points: 2 },
          { emoji: '📝', text: 'Un brouillon avec de nombreuses modifications en attente', subtext: 'A rough draft with many edits pending', points: 1 },
          { emoji: '🎬', text: 'Un scénario qui est principalement sur la bonne voie', subtext: 'A script that is mostly on track', points: 3 },
          { emoji: '📖', text: 'Un récit qui se déroule comme il se doit', subtext: 'A narrative unfolding the way it should', points: 5 },
        ],
      },
      {
        id: 'q2',
        ...
        options: [
          { emoji: '🥤', text: 'Comme une canette de soda secouée', subtext: 'Like a shaken soda can', points: 0 },
          { emoji: '🏠', text: 'Comme une pièce qui se salit puis se réinitialise', subtext: 'Like a room that gets messy and then reset', points: 1 },
          { emoji: '💧', text: 'Comme un étang avec de rares ondulations', subtext: 'Like a pond with rare ripples', points: 2 },
          { emoji: '🌊', text: 'Comme un lac profond, principalement calme à l\'intérieur', subtext: 'Like a deep lake, mostly still inside', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🤖', text: 'En pilote automatique, je passe simplement par les mouvements', subtext: 'On autopilot, just going through motions', points: 0 },
          { emoji: '🌫️', text: 'Avec une idée vague de ce qu\'il faut faire', subtext: 'With a vague idea of what to do', points: 1 },
          { emoji: '🗺️', text: 'Avec un plan de jeu approximatif en tête', subtext: 'With a loose game plan in mind', points: 3 },
          { emoji: '🧭', text: 'Avec une boussole intérieure claire pour la journée', subtext: 'With a clear inner compass for the day', points: 4 },
        ],
      },
      {
        id: 'q4',
        ...
        options: [
          { emoji: '🏚️', text: 'Comme vivre dans une maison que je n\'ai jamais choisie', subtext: 'Like living in a house I never chose', points: 0 },
          { emoji: '🏠', text: 'Comme une maison avec quelques bonnes pièces', subtext: 'Like a house with a few right rooms', points: 2 },
          { emoji: '🏡', text: 'Comme la maison que j\'avais grossièrement imaginée', subtext: 'Like the home I had roughly imagined', points: 1 },
          { emoji: '🖼️', text: 'Comme entrer dans la vie que j\'ai autrefois dessinée sur papier', subtext: 'Like walking inside the life I once drew on paper', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '📢', text: 'Principalement comme une critique de fond', subtext: 'Mostly like background criticism', points: 0 },
          { emoji: '⚖️', text: 'Un mélange de doutes et de petits discours d\'encouragement', subtext: 'A mix of doubts and small pep talks', points: 1 },
          { emoji: '🧠', text: 'Souvent comme un coach intérieur de soutien', subtext: 'Often like a supportive inner coach', points: 3 },
          { emoji: '📣', text: 'En grande partie comme une équipe d\'encouragement intérieure stable', subtext: 'Largely like a steady inner cheer squad', points: 4 },
        ],
      },
      {
        id: 'q6',
        ...
        options: [
          { emoji: '☁️', text: 'Presque jamais, la plupart des jours semblent plats', subtext: 'Almost never, most days feel flat', points: 0 },
          { emoji: '⚡', text: 'De petites étincelles apparaissent de temps en temps', subtext: 'Small sparks show up once in a while', points: 1 },
          { emoji: '🕯️', text: 'Une lueur douce est présente plusieurs jours', subtext: 'A gentle glow is present on many days', points: 2 },
          { emoji: '🔥', text: 'Des éclats fréquents qui me poussent à agir', subtext: 'Frequent bursts that move me to act', points: 3 },
          { emoji: '☀️', text: 'Un feu intérieur constant qui me maintient en création', subtext: 'A steady inner fire that keeps me creating', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '💥', text: 'Je m\'effondre émotionnellement quand les plans changent', subtext: 'I crash emotionally when plans change', points: 0 },
          { emoji: '😰', text: 'Je suis gravement secoué et reste contrarié', subtext: 'I get badly shaken and stay upset', points: 1 },
          { emoji: '🌀', text: 'Je vacille mais retrouve l\'équilibre', subtext: 'I wobble but regain balance', points: 3 },
          { emoji: '🧘', text: 'Je m\'adapte avec un léger inconfort', subtext: 'I adjust with mild discomfort', points: 2 },
          { emoji: '🎯', text: 'Je reste centré et je trace simplement une nouvelle route', subtext: 'I stay centred and simply re-route', points: 4 },
        ],
      },
      {
        id: 'q8',
        ...
        options: [
          { emoji: '🔇', text: 'Principalement en sourdine, l\'esprit est ailleurs', subtext: 'Mostly on mute, mind is elsewhere', points: 0 },
          { emoji: '↔️', text: 'Moitié ici, moitié sur la prochaine chose', subtext: 'Half here, half on the next thing', points: 1 },
          { emoji: '👁️', text: 'Généralement présent avec quelques oublis', subtext: 'Generally present with a few slips', points: 2 },
          { emoji: '⏰', text: 'Suffisamment immergé pour perdre la notion du temps', subtext: 'Immersed enough to lose track of time', points: 3 },
          { emoji: '✨', text: 'Profondément absorbé, la vie semble vivante', subtext: 'Deeply absorbed, life feels vivid', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌑', text: 'Un couloir avec les lumières éteintes', subtext: 'A corridor with lights switched off', points: 0 },
          { emoji: '🌫️', text: 'Une ruelle brumeuse avec des contours faibles', subtext: 'A foggy lane with faint outlines', points: 1 },
          { emoji: '🛣️', text: 'Une route sinueuse avec des lampes à intervalles', subtext: 'A winding road with lamps at intervals', points: 2 },
          { emoji: '🛤️', text: 'Une autoroute ouverte avec des panneaux clairs', subtext: 'An open highway with clear signboards', points: 3 },
          { emoji: '🌅', text: 'Un large horizon avec de nombreux chemins lumineux', subtext: 'A wide horizon with many bright paths', points: 4 },
        ],
      },
      {
        id: 'q10',
        ...
        options: [
          { emoji: '📉', text: 'Principalement des pertes émotionnelles ou des drains', subtext: 'Mostly emotional losses or drains', points: 0 },
          { emoji: '💫', text: 'Quelques moments dispersés de retour', subtext: 'A few scattered moments of return', points: 2 },
          { emoji: '⚖️', text: 'Une part équitable de joie et d\'accomplissement', subtext: 'A fair share of joy and fulfilment', points: 1 },
          { emoji: '📈', text: 'Des retours constants qui semblent valoir l\'effort', subtext: 'Consistent returns that feel worth the effort', points: 3 },
          { emoji: '💎', text: 'De riches dividendes émotionnels dans la plupart des domaines', subtext: 'Rich emotional dividends in most areas', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🔄', text: 'Je me sens coincé en répétition', subtext: 'I feel stuck on repeat', points: 0 },
          { emoji: '📊', text: 'Je ne grandis que par petits sauts rares', subtext: 'I grow only in small, rare jumps', points: 1 },
          { emoji: '🌱', text: 'Je peux sentir une croissance intérieure constante', subtext: 'I can sense steady inner growth', points: 3 },
          { emoji: '🌳', text: 'Je continue d\'évoluer de manière notable', subtext: 'I keep evolving in noticeable ways', points: 4 },
        ],
      },
      {
        id: 'q12',
        ...
        options: [
          { emoji: '🚨', text: 'Principalement la survie et l\'urgence me conduisent', subtext: 'Mostly survival and urgency drive me', points: 0 },
          { emoji: '🤔', text: 'Parfois je vérifie si cela compte vraiment', subtext: 'Sometimes I check if it truly matters', points: 2 },
          { emoji: '🧭', text: 'Souvent je vérifie l\'alignement avec mon pourquoi', subtext: 'Often I check alignment with my why', points: 1 },
          { emoji: '⭐', text: 'En grande partie mes choix suivent un but intérieur clair', subtext: 'Largely my choices follow a clear inner purpose', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🎭', text: 'Je porte souvent des masques pour passer', subtext: 'I often wear masks to get through', points: 0 },
          { emoji: '👥', text: 'Je ne peux être moi-même qu\'avec quelques personnes', subtext: 'I can be myself only with a few people', points: 1 },
          { emoji: '😊', text: 'Je suis principalement moi-même dans la plupart des espaces', subtext: 'I am mostly myself in most spaces', points: 3 },
          { emoji: '💯', text: 'Je me sens chez moi dans ma peau presque partout', subtext: 'I feel at home in my own skin almost everywhere', points: 4 },
        ],
      },
      {
        id: 'q14',
        ...
        options: [
          { emoji: '🚫', text: 'J\'évite d\'être seul avec moi-même', subtext: 'I avoid being alone with myself', points: 0 },
          { emoji: '⏱️', text: 'Je tolère ma propre compagnie à petites doses', subtext: 'I tolerate my own company in small doses', points: 1 },
          { emoji: '👍', text: 'J\'aime généralement passer du temps avec moi-même', subtext: 'I generally like spending time with myself', points: 2 },
          { emoji: '💖', text: 'J\'attends vraiment avec impatience mon temps seul', subtext: 'I genuinely look forward to my alone time', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🚧', text: 'Les gens hésitent à s\'ouvrir à moi', subtext: 'People hesitate to open up to me', points: 0 },
          { emoji: '🤐', text: 'Quelques-uns partagent, mais avec prudence', subtext: 'A few share, but cautiously', points: 1 },
          { emoji: '🤗', text: 'Beaucoup de gens me font confiance facilement', subtext: 'Many people confide in me with ease', points: 3 },
          { emoji: '🛡️', text: 'Je suis souvent la personne vers qui les gens se tournent en premier', subtext: 'I am often the person people turn to first', points: 4 },
        ],
      },
      {
        id: 'q16',
        ...
        options: [
          { emoji: '😶', text: 'Je lutte pour me souvenir de quelque chose d\'agréable', subtext: 'I struggle to recall anything pleasant', points: 0 },
          { emoji: '🌟', text: 'Quelques bons moments dispersés me viennent', subtext: 'A few scattered good moments come up', points: 1 },
          { emoji: '😌', text: 'Plusieurs souvenirs chaleureux surgissent facilement', subtext: 'Several warm memories surface easily', points: 2 },
          { emoji: '🌈', text: 'De nombreux moments agréables vifs me viennent à l\'esprit à la fois', subtext: 'Many vivid pleasant moments come to mind at once', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌪️', text: 'Mes humeurs sont instables indépendamment du sommeil', subtext: 'My moods are unstable regardless of sleep', points: 0 },
          { emoji: '🤷', text: 'Le sommeil aide un peu mais pas de manière fiable', subtext: 'Sleep helps a little but not reliably', points: 1 },
          { emoji: '😴', text: 'Un bon sommeil me maintient généralement plus stable', subtext: 'Good sleep usually keeps me steadier', points: 2 },
          { emoji: '⚓', text: 'Un bon sommeil ancre clairement mon équilibre émotionnel', subtext: 'Good sleep clearly anchors my emotional balance', points: 3 },
        ],
      },
      {
        id: 'q18',
        ...
        options: [
          { emoji: '📉', text: 'L\'énergie chute fortement tout au long de la journée', subtext: 'Energy drops sharply through the day', points: 0 },
          { emoji: '📊', text: 'Mon graphique d\'énergie est un zigzag continu', subtext: 'My energy graph is a continuous zigzag', points: 1 },
          { emoji: '➖', text: 'L\'énergie est principalement stable avec de légères baisses', subtext: 'Energy is mostly steady with mild dips', points: 2 },
          { emoji: '🔋', text: 'Je me sens durablement énergisé la plupart de la journée', subtext: 'I feel sustainably energised most of the day', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '⛓️', text: 'Principalement des interactions épuisantes ou déconnectantes', subtext: 'Mostly draining or disconnecting interactions', points: 0 },
          { emoji: '😐', text: 'Échanges neutres sans beaucoup de sentiment', subtext: 'Neutral exchanges without much feeling', points: 1 },
          { emoji: '🤝', text: 'Généralement des moments chaleureux et connectants', subtext: 'Generally warm and connecting moments', points: 2 },
          { emoji: '💞', text: 'Connexions profondes et nourrissantes dans de nombreuses interactions', subtext: 'Deep, nourishing connections in many interactions', points: 3 },
        ],
      },
      {
        id: 'q20',
        ...
        options: [
          { emoji: '🖼️', text: 'Comme un papier peint de fond que je remarque à peine', subtext: 'Like background wallpaper I hardly notice', points: 0 },
          { emoji: '🎬', text: 'Comme un film que je regarde depuis la touche', subtext: 'Like a movie I watch from the side-lines', points: 1 },
          { emoji: '🎮', text: 'Comme un jeu auquel je participe de temps en temps', subtext: 'Like a game I join in now and then', points: 3 },
          { emoji: '🎢', text: 'Comme une aventure qui se déroule dont je fais pleinement partie', subtext: 'Like an unfolding adventure I am fully part of', points: 4 },
        ],
      },
    ],
  },
...
export default function FrenchQuizPage() {
  ...
  useEffect(() => {
    localStorage.removeItem('quizAnswersFrench');
    localStorage.removeItem('quizCurrentPageFrench');
    localStorage.removeItem('userFormFrench');
    localStorage.removeItem('totalScoreFrench');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <footer className="sticky bottom-0 left-0 right-0 bg-white border-t px-6 py-4 flex gap-3 mt-6">
        ...
        >
          {currentPage === totalPages ? 'Suivant' : 'Suivant'}
        </button>
      </footer>
    </div>
  );
