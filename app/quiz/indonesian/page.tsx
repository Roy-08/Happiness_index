    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🧩', text: 'Sebuah cerita yang terus kehilangan alurnya', subtext: 'A story that keeps losing its plot', points: 2 },
          { emoji: '📝', text: 'Draf kasar dengan banyak pengeditan yang tertunda', subtext: 'A rough draft with many edits pending', points: 1 },
          { emoji: '🎬', text: 'Skrip yang sebagian besar berada di jalur yang benar', subtext: 'A script that is mostly on track', points: 3 },
          { emoji: '📖', text: 'Narasi yang terungkap sebagaimana mestinya', subtext: 'A narrative unfolding the way it should', points: 5 },
        ],
      },
      {
        id: 'q2',
        ...
        options: [
          { emoji: '🥤', text: 'Seperti kaleng soda yang dikocok', subtext: 'Like a shaken soda can', points: 0 },
          { emoji: '🏠', text: 'Seperti ruangan yang berantakan lalu direset', subtext: 'Like a room that gets messy and then reset', points: 1 },
          { emoji: '💧', text: 'Seperti kolam dengan riak yang jarang', subtext: 'Like a pond with rare ripples', points: 2 },
          { emoji: '🌊', text: 'Seperti danau dalam, sebagian besar tenang di dalam', subtext: 'Like a deep lake, mostly still inside', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🤖', text: 'Autopilot, hanya menjalani gerakan', subtext: 'On autopilot, just going through motions', points: 0 },
          { emoji: '🌫️', text: 'Dengan ide samar tentang apa yang harus dilakukan', subtext: 'With a vague idea of what to do', points: 1 },
          { emoji: '🗺️', text: 'Dengan rencana permainan longgar dalam pikiran', subtext: 'With a loose game plan in mind', points: 3 },
          { emoji: '🧭', text: 'Dengan kompas batin yang jelas untuk hari ini', subtext: 'With a clear inner compass for the day', points: 4 },
        ],
      },
      {
        id: 'q4',
        ...
        options: [
          { emoji: '🏚️', text: 'Seperti tinggal di rumah yang tidak pernah saya pilih', subtext: 'Like living in a house I never chose', points: 0 },
          { emoji: '🏠', text: 'Seperti rumah dengan beberapa ruangan yang tepat', subtext: 'Like a house with a few right rooms', points: 2 },
          { emoji: '🏡', text: 'Seperti rumah yang saya bayangkan secara kasar', subtext: 'Like the home I had roughly imagined', points: 1 },
          { emoji: '🖼️', text: 'Seperti berjalan di dalam kehidupan yang pernah saya gambar di atas kertas', subtext: 'Like walking inside the life I once drew on paper', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '📢', text: 'Kebanyakan seperti kritik latar belakang', subtext: 'Mostly like background criticism', points: 0 },
          { emoji: '⚖️', text: 'Campuran keraguan dan pep talk kecil', subtext: 'A mix of doubts and small pep talks', points: 1 },
          { emoji: '🧠', text: 'Sering seperti pelatih batin yang mendukung', subtext: 'Often like a supportive inner coach', points: 3 },
          { emoji: '📣', text: 'Sebagian besar seperti regu sorak batin yang stabil', subtext: 'Largely like a steady inner cheer squad', points: 4 },
        ],
      },
      {
        id: 'q6',
        ...
        options: [
          { emoji: '☁️', text: 'Hampir tidak pernah, sebagian besar hari terasa datar', subtext: 'Almost never, most days feel flat', points: 0 },
          { emoji: '⚡', text: 'Percikan kecil muncul sesekali', subtext: 'Small sparks show up once in a while', points: 1 },
          { emoji: '🕯️', text: 'Cahaya lembut hadir di banyak hari', subtext: 'A gentle glow is present on many days', points: 2 },
          { emoji: '🔥', text: 'Ledakan sering yang menggerakkan saya untuk bertindak', subtext: 'Frequent bursts that move me to act', points: 3 },
          { emoji: '☀️', text: 'Api batin yang stabil yang membuat saya terus berkarya', subtext: 'A steady inner fire that keeps me creating', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '💥', text: 'Saya hancur secara emosional ketika rencana berubah', subtext: 'I crash emotionally when plans change', points: 0 },
          { emoji: '😰', text: 'Saya sangat terguncang dan tetap kesal', subtext: 'I get badly shaken and stay upset', points: 1 },
          { emoji: '🌀', text: 'Saya goyah tapi mendapatkan kembali keseimbangan', subtext: 'I wobble but regain balance', points: 3 },
          { emoji: '🧘', text: 'Saya menyesuaikan dengan ketidaknyamanan ringan', subtext: 'I adjust with mild discomfort', points: 2 },
          { emoji: '🎯', text: 'Saya tetap terpusat dan hanya mengalihkan rute', subtext: 'I stay centred and simply re-route', points: 4 },
        ],
      },
      {
        id: 'q8',
        ...
        options: [
          { emoji: '🔇', text: 'Kebanyakan dalam mode diam, pikiran ada di tempat lain', subtext: 'Mostly on mute, mind is elsewhere', points: 0 },
          { emoji: '↔️', text: 'Setengah di sini, setengah pada hal berikutnya', subtext: 'Half here, half on the next thing', points: 1 },
          { emoji: '👁️', text: 'Umumnya hadir dengan beberapa kesalahan', subtext: 'Generally present with a few slips', points: 2 },
          { emoji: '⏰', text: 'Cukup terbenam untuk kehilangan jejak waktu', subtext: 'Immersed enough to lose track of time', points: 3 },
          { emoji: '✨', text: 'Sangat terserap, hidup terasa jelas', subtext: 'Deeply absorbed, life feels vivid', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌑', text: 'Koridor dengan lampu dimatikan', subtext: 'A corridor with lights switched off', points: 0 },
          { emoji: '🌫️', text: 'Jalur berkabut dengan garis samar', subtext: 'A foggy lane with faint outlines', points: 1 },
          { emoji: '🛣️', text: 'Jalan berliku dengan lampu di interval', subtext: 'A winding road with lamps at intervals', points: 2 },
          { emoji: '🛤️', text: 'Jalan raya terbuka dengan papan tanda yang jelas', subtext: 'An open highway with clear signboards', points: 3 },
          { emoji: '🌅', text: 'Cakrawala luas dengan banyak jalur cerah', subtext: 'A wide horizon with many bright paths', points: 4 },
        ],
      },
      {
        id: 'q10',
        ...
        options: [
          { emoji: '📉', text: 'Kebanyakan kerugian emosional atau pengurasan', subtext: 'Mostly emotional losses or drains', points: 0 },
          { emoji: '💫', text: 'Beberapa momen pengembalian yang tersebar', subtext: 'A few scattered moments of return', points: 2 },
          { emoji: '⚖️', text: 'Bagian yang adil dari kegembiraan dan pemenuhan', subtext: 'A fair share of joy and fulfilment', points: 1 },
          { emoji: '📈', text: 'Pengembalian konsisten yang terasa layak untuk usaha', subtext: 'Consistent returns that feel worth the effort', points: 3 },
          { emoji: '💎', text: 'Dividen emosional yang kaya di sebagian besar area', subtext: 'Rich emotional dividends in most areas', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🔄', text: 'Saya merasa terjebak dalam pengulangan', subtext: 'I feel stuck on repeat', points: 0 },
          { emoji: '📊', text: 'Saya tumbuh hanya dalam lompatan kecil yang jarang', subtext: 'I grow only in small, rare jumps', points: 1 },
          { emoji: '🌱', text: 'Saya dapat merasakan pertumbuhan batin yang stabil', subtext: 'I can sense steady inner growth', points: 3 },
          { emoji: '🌳', text: 'Saya terus berkembang dengan cara yang terlihat', subtext: 'I keep evolving in noticeable ways', points: 4 },
        ],
      },
      {
        id: 'q12',
        ...
        options: [
          { emoji: '🚨', text: 'Kebanyakan kelangsungan hidup dan urgensi yang mendorong saya', subtext: 'Mostly survival and urgency drive me', points: 0 },
          { emoji: '🤔', text: 'Kadang-kadang saya memeriksa apakah itu benar-benar penting', subtext: 'Sometimes I check if it truly matters', points: 2 },
          { emoji: '🧭', text: 'Sering saya memeriksa keselarasan dengan "mengapa" saya', subtext: 'Often I check alignment with my why', points: 1 },
          { emoji: '⭐', text: 'Sebagian besar pilihan saya mengikuti tujuan batin yang jelas', subtext: 'Largely my choices follow a clear inner purpose', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🎭', text: 'Saya sering memakai topeng untuk melewati', subtext: 'I often wear masks to get through', points: 0 },
          { emoji: '👥', text: 'Saya hanya bisa menjadi diri sendiri dengan beberapa orang', subtext: 'I can be myself only with a few people', points: 1 },
          { emoji: '😊', text: 'Saya sebagian besar diri sendiri di sebagian besar ruang', subtext: 'I am mostly myself in most spaces', points: 3 },
          { emoji: '💯', text: 'Saya merasa di rumah dalam kulit saya sendiri hampir di mana-mana', subtext: 'I feel at home in my own skin almost everywhere', points: 4 },
        ],
      },
      {
        id: 'q14',
        ...
        options: [
          { emoji: '🚫', text: 'Saya menghindari sendirian dengan diri sendiri', subtext: 'I avoid being alone with myself', points: 0 },
          { emoji: '⏱️', text: 'Saya mentolerir kebersamaan saya sendiri dalam dosis kecil', subtext: 'I tolerate my own company in small doses', points: 1 },
          { emoji: '👍', text: 'Saya umumnya suka menghabiskan waktu dengan diri sendiri', subtext: 'I generally like spending time with myself', points: 2 },
          { emoji: '💖', text: 'Saya benar-benar menantikan waktu sendirian saya', subtext: 'I genuinely look forward to my alone time', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🚧', text: 'Orang-orang ragu untuk terbuka kepada saya', subtext: 'People hesitate to open up to me', points: 0 },
          { emoji: '🤐', text: 'Beberapa berbagi, tetapi dengan hati-hati', subtext: 'A few share, but cautiously', points: 1 },
          { emoji: '🤗', text: 'Banyak orang mempercayai saya dengan mudah', subtext: 'Many people confide in me with ease', points: 3 },
          { emoji: '🛡️', text: 'Saya sering menjadi orang yang pertama kali didatangi orang', subtext: 'I am often the person people turn to first', points: 4 },
        ],
      },
      {
        id: 'q16',
        ...
        options: [
          { emoji: '😶', text: 'Saya kesulitan mengingat sesuatu yang menyenangkan', subtext: 'I struggle to recall anything pleasant', points: 0 },
          { emoji: '🌟', text: 'Beberapa momen baik yang tersebar muncul', subtext: 'A few scattered good moments come up', points: 1 },
          { emoji: '😌', text: 'Beberapa kenangan hangat muncul dengan mudah', subtext: 'Several warm memories surface easily', points: 2 },
          { emoji: '🌈', text: 'Banyak momen menyenangkan yang jelas terlintas sekaligus', subtext: 'Many vivid pleasant moments come to mind at once', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌪️', text: 'Suasana hati saya tidak stabil terlepas dari tidur', subtext: 'My moods are unstable regardless of sleep', points: 0 },
          { emoji: '🤷', text: 'Tidur membantu sedikit tetapi tidak dapat diandalkan', subtext: 'Sleep helps a little but not reliably', points: 1 },
          { emoji: '😴', text: 'Tidur yang baik biasanya membuat saya lebih stabil', subtext: 'Good sleep usually keeps me steadier', points: 2 },
          { emoji: '⚓', text: 'Tidur yang baik jelas menambatkan keseimbangan emosional saya', subtext: 'Good sleep clearly anchors my emotional balance', points: 3 },
        ],
      },
      {
        id: 'q18',
        ...
        options: [
          { emoji: '📉', text: 'Energi turun tajam sepanjang hari', subtext: 'Energy drops sharply through the day', points: 0 },
          { emoji: '📊', text: 'Grafik energi saya adalah zigzag berkelanjutan', subtext: 'My energy graph is a continuous zigzag', points: 1 },
          { emoji: '➖', text: 'Energi sebagian besar stabil dengan penurunan ringan', subtext: 'Energy is mostly steady with mild dips', points: 2 },
          { emoji: '🔋', text: 'Saya merasa berenergi secara berkelanjutan sebagian besar hari', subtext: 'I feel sustainably energised most of the day', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '⛓️', text: 'Kebanyakan interaksi yang menguras atau memutuskan', subtext: 'Mostly draining or disconnecting interactions', points: 0 },
          { emoji: '😐', text: 'Pertukaran netral tanpa banyak perasaan', subtext: 'Neutral exchanges without much feeling', points: 1 },
          { emoji: '🤝', text: 'Umumnya momen hangat dan menghubungkan', subtext: 'Generally warm and connecting moments', points: 2 },
          { emoji: '💞', text: 'Koneksi yang dalam dan bergizi dalam banyak interaksi', subtext: 'Deep, nourishing connections in many interactions', points: 3 },
        ],
      },
      {
        id: 'q20',
        ...
        options: [
          { emoji: '🖼️', text: 'Seperti wallpaper latar belakang yang hampir tidak saya perhatikan', subtext: 'Like background wallpaper I hardly notice', points: 0 },
          { emoji: '🎬', text: 'Seperti film yang saya tonton dari pinggir', subtext: 'Like a movie I watch from the side-lines', points: 1 },
          { emoji: '🎮', text: 'Seperti permainan yang saya ikuti sesekali', subtext: 'Like a game I join in now and then', points: 3 },
          { emoji: '🎢', text: 'Seperti petualangan yang terungkap yang saya menjadi bagian penuhnya', subtext: 'Like an unfolding adventure I am fully part of', points: 4 },
        ],
      },
    ],
  },
...
export default function IndonesianQuizPage() {
  ...
  useEffect(() => {
    ...
    localStorage.removeItem('indonesianUserForm');
    localStorage.removeItem('indonesianTotalScore');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <footer className="sticky bottom-0 left-0 right-0 bg-white border-t px-6 py-4 flex gap-3 mt-6">
        ...
        >
          {currentPage === totalPages ? 'Berikutnya' : 'Berikutnya'}
        </button>
      </footer>
    </div>
  );
