    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🧩', text: 'Fabula quae argumentum suum amittere pergit', subtext: 'A story that keeps losing its plot', points: 2 },
          { emoji: '📝', text: 'Exemplar asperum cum multis emendationibus pendentibus', subtext: 'A rough draft with many edits pending', points: 1 },
          { emoji: '🎬', text: 'Scriptum quod maxime in via recta est', subtext: 'A script that is mostly on track', points: 3 },
          { emoji: '📖', text: 'Narratio quae explicatur sicut debet', subtext: 'A narrative unfolding the way it should', points: 5 },
        ],
      },
      {
        id: 'q2',
        ...
        options: [
          { emoji: '🥤', text: 'Sicut pyxis sodae agitata', subtext: 'Like a shaken soda can', points: 0 },
          { emoji: '🏠', text: 'Sicut camera quae sordida fit et deinde restituitur', subtext: 'Like a room that gets messy and then reset', points: 1 },
          { emoji: '💧', text: 'Sicut stagnum cum raris undulis', subtext: 'Like a pond with rare ripples', points: 2 },
          { emoji: '🌊', text: 'Sicut lacus profundus, maxime quietus intus', subtext: 'Like a deep lake, mostly still inside', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🤖', text: 'In autopiloto, tantum per motus transiens', subtext: 'On autopilot, just going through motions', points: 0 },
          { emoji: '🌫️', text: 'Cum vaga idea quid facere', subtext: 'With a vague idea of what to do', points: 1 },
          { emoji: '🗺️', text: 'Cum laxo consilio ludi in mente', subtext: 'With a loose game plan in mind', points: 3 },
          { emoji: '🧭', text: 'Cum clara pyxide interiore pro die', subtext: 'With a clear inner compass for the day', points: 4 },
        ],
      },
      {
        id: 'q4',
        ...
        options: [
          { emoji: '🏚️', text: 'Sicut vivere in domo quam numquam elegi', subtext: 'Like living in a house I never chose', points: 0 },
          { emoji: '🏠', text: 'Sicut domus cum paucis cameris rectis', subtext: 'Like a house with a few right rooms', points: 2 },
          { emoji: '🏡', text: 'Sicut domus quam aspere imaginatus sum', subtext: 'Like the home I had roughly imagined', points: 1 },
          { emoji: '🖼️', text: 'Sicut ambulare intra vitam quam olim in charta pinxi', subtext: 'Like walking inside the life I once drew on paper', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '📢', text: 'Maxime sicut critica in fundo', subtext: 'Mostly like background criticism', points: 0 },
          { emoji: '⚖️', text: 'Mixtura dubitationum et parvarum exhortationum', subtext: 'A mix of doubts and small pep talks', points: 1 },
          { emoji: '🧠', text: 'Saepe sicut magister interior sustinens', subtext: 'Often like a supportive inner coach', points: 3 },
          { emoji: '📣', text: 'Magna ex parte sicut stabilis cohors interior exhortans', subtext: 'Largely like a steady inner cheer squad', points: 4 },
        ],
      },
      {
        id: 'q6',
        ...
        options: [
          { emoji: '☁️', text: 'Fere numquam, plurimi dies plani videntur', subtext: 'Almost never, most days feel flat', points: 0 },
          { emoji: '⚡', text: 'Parvae scintillae interdum apparent', subtext: 'Small sparks show up once in a while', points: 1 },
          { emoji: '🕯️', text: 'Lenis fulgor multis diebus adest', subtext: 'A gentle glow is present on many days', points: 2 },
          { emoji: '🔥', text: 'Frequentes eruptiones quae me ad agendum movent', subtext: 'Frequent bursts that move me to act', points: 3 },
          { emoji: '☀️', text: 'Stabilis ignis interior qui me creantem servat', subtext: 'A steady inner fire that keeps me creating', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '💥', text: 'Emotionaliter corruo cum consilia mutantur', subtext: 'I crash emotionally when plans change', points: 0 },
          { emoji: '😰', text: 'Graviter concutior et turbatus maneo', subtext: 'I get badly shaken and stay upset', points: 1 },
          { emoji: '🌀', text: 'Vacillo sed aequilibrium recupero', subtext: 'I wobble but regain balance', points: 3 },
          { emoji: '🧘', text: 'Me accommodo cum levi incommodo', subtext: 'I adjust with mild discomfort', points: 2 },
          { emoji: '🎯', text: 'Centratus maneo et simpliciter viam muto', subtext: 'I stay centred and simply re-route', points: 4 },
        ],
      },
      {
        id: 'q8',
        ...
        options: [
          { emoji: '🔇', text: 'Maxime in silentio, mens alibi est', subtext: 'Mostly on mute, mind is elsewhere', points: 0 },
          { emoji: '↔️', text: 'Dimidium hic, dimidium in re proxima', subtext: 'Half here, half on the next thing', points: 1 },
          { emoji: '👁️', text: 'Generaliter praesens cum paucis lapsis', subtext: 'Generally present with a few slips', points: 2 },
          { emoji: '⏰', text: 'Satis immersus ut notionem temporis amittam', subtext: 'Immersed enough to lose track of time', points: 3 },
          { emoji: '✨', text: 'Profunde absorptus, vita vivida videtur', subtext: 'Deeply absorbed, life feels vivid', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌑', text: 'Corridor cum luminibus exstinctis', subtext: 'A corridor with lights switched off', points: 0 },
          { emoji: '🌫️', text: 'Via nebulosa cum tenuibus lineamentis', subtext: 'A foggy lane with faint outlines', points: 1 },
          { emoji: '🛣️', text: 'Via tortuosa cum lucernis per intervalla', subtext: 'A winding road with lamps at intervals', points: 2 },
          { emoji: '🛤️', text: 'Via publica aperta cum claris titulis', subtext: 'An open highway with clear signboards', points: 3 },
          { emoji: '🌅', text: 'Horizon latus cum multis viis claris', subtext: 'A wide horizon with many bright paths', points: 4 },
        ],
      },
      {
        id: 'q10',
        ...
        options: [
          { emoji: '📉', text: 'Maxime damna emotionalia vel exhausta', subtext: 'Mostly emotional losses or drains', points: 0 },
          { emoji: '💫', text: 'Pauca momenta dispersa reditus', subtext: 'A few scattered moments of return', points: 2 },
          { emoji: '⚖️', text: 'Aequa pars gaudii et completionis', subtext: 'A fair share of joy and fulfilment', points: 1 },
          { emoji: '📈', text: 'Constantes reditus qui digni conatu videntur', subtext: 'Consistent returns that feel worth the effort', points: 3 },
          { emoji: '💎', text: 'Divitiae dividenda emotionalia in plurimis partibus', subtext: 'Rich emotional dividends in most areas', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🔄', text: 'Sentio me haerere in iteratione', subtext: 'I feel stuck on repeat', points: 0 },
          { emoji: '📊', text: 'Cresco tantum in parvis raris saltibus', subtext: 'I grow only in small, rare jumps', points: 1 },
          { emoji: '🌱', text: 'Possum sentire stabilem incrementum interius', subtext: 'I can sense steady inner growth', points: 3 },
          { emoji: '🌳', text: 'Pergo evolvere modis notabilibus', subtext: 'I keep evolving in noticeable ways', points: 4 },
        ],
      },
      {
        id: 'q12',
        ...
        options: [
          { emoji: '🚨', text: 'Maxime superviventia et urgentia me impellunt', subtext: 'Mostly survival and urgency drive me', points: 0 },
          { emoji: '🤔', text: 'Interdum examino an vere referat', subtext: 'Sometimes I check if it truly matters', points: 2 },
          { emoji: '🧭', text: 'Saepe examino consonantiam cum meo "cur"', subtext: 'Often I check alignment with my why', points: 1 },
          { emoji: '⭐', text: 'Magna ex parte electiones meae sequuntur clarum propositum interius', subtext: 'Largely my choices follow a clear inner purpose', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🎭', text: 'Saepe personas gero ut transeam', subtext: 'I often wear masks to get through', points: 0 },
          { emoji: '👥', text: 'Possum esse me ipsum tantum cum paucis hominibus', subtext: 'I can be myself only with a few people', points: 1 },
          { emoji: '😊', text: 'Sum maxime me ipsum in plurimis spatiis', subtext: 'I am mostly myself in most spaces', points: 3 },
          { emoji: '💯', text: 'Sentio me domi in mea ipsius cute fere ubique', subtext: 'I feel at home in my own skin almost everywhere', points: 4 },
        ],
      },
      {
        id: 'q14',
        ...
        options: [
          { emoji: '🚫', text: 'Vito esse solus mecum ipso', subtext: 'I avoid being alone with myself', points: 0 },
          { emoji: '⏱️', text: 'Tolero meum ipsum comitatum in parvis dosibus', subtext: 'I tolerate my own company in small doses', points: 1 },
          { emoji: '👍', text: 'Generaliter amo tempus consumere mecum ipso', subtext: 'I generally like spending time with myself', points: 2 },
          { emoji: '💖', text: 'Vere exspecto meum tempus solum', subtext: 'I genuinely look forward to my alone time', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🚧', text: 'Homines dubitant se aperire mihi', subtext: 'People hesitate to open up to me', points: 0 },
          { emoji: '🤐', text: 'Pauci communicant, sed caute', subtext: 'A few share, but cautiously', points: 1 },
          { emoji: '🤗', text: 'Multi homines mihi confidunt cum facilitate', subtext: 'Many people confide in me with ease', points: 3 },
          { emoji: '🛡️', text: 'Saepe sum persona ad quam homines primo se vertunt', subtext: 'I am often the person people turn to first', points: 4 },
        ],
      },
      {
        id: 'q16',
        ...
        options: [
          { emoji: '😶', text: 'Luctor recordari quidquam iucundum', subtext: 'I struggle to recall anything pleasant', points: 0 },
          { emoji: '🌟', text: 'Pauca momenta bona dispersa surgunt', subtext: 'A few scattered good moments come up', points: 1 },
          { emoji: '😌', text: 'Plures calidae memoriae facile emergunt', subtext: 'Several warm memories surface easily', points: 2 },
          { emoji: '🌈', text: 'Multa vivida momenta iucunda simul in mentem veniunt', subtext: 'Many vivid pleasant moments come to mind at once', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌪️', text: 'Modi mei instabiles sunt sine respectu somni', subtext: 'My moods are unstable regardless of sleep', points: 0 },
          { emoji: '🤷', text: 'Somnus paulum adiuvat sed non fideliter', subtext: 'Sleep helps a little but not reliably', points: 1 },
          { emoji: '😴', text: 'Bonus somnus me stabilem servat', subtext: 'Good sleep usually keeps me steadier', points: 2 },
          { emoji: '⚓', text: 'Bonus somnus clare aequilibrium meum emotionale ancora', subtext: 'Good sleep clearly anchors my emotional balance', points: 3 },
        ],
      },
      {
        id: 'q18',
        ...
        options: [
          { emoji: '📉', text: 'Energia acriter cadit per diem', subtext: 'Energy drops sharply through the day', points: 0 },
          { emoji: '📊', text: 'Graphicum energiae meae est continuum zigzag', subtext: 'My energy graph is a continuous zigzag', points: 1 },
          { emoji: '➖', text: 'Energia maxime stabilis est cum levibus descensibus', subtext: 'Energy is mostly steady with mild dips', points: 2 },
          { emoji: '🔋', text: 'Sentio me sustentabiliter energicum plurimam partem diei', subtext: 'I feel sustainably energised most of the day', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '⛓️', text: 'Maxime interactiones exhaurientes vel disconectentes', subtext: 'Mostly draining or disconnecting interactions', points: 0 },
          { emoji: '😐', text: 'Mutationes neutrales sine multo sensu', subtext: 'Neutral exchanges without much feeling', points: 1 },
          { emoji: '🤝', text: 'Generaliter momenta calida et conectentia', subtext: 'Generally warm and connecting moments', points: 2 },
          { emoji: '💞', text: 'Conexiones profundae et nutrientes in multis interactionibus', subtext: 'Deep, nourishing connections in many interactions', points: 3 },
        ],
      },
      {
        id: 'q20',
        ...
        options: [
          { emoji: '🖼️', text: 'Sicut tapetum in fundo quod vix animadverto', subtext: 'Like background wallpaper I hardly notice', points: 0 },
          { emoji: '🎬', text: 'Sicut cinematographum quod specto a lateribus', subtext: 'Like a movie I watch from the side-lines', points: 1 },
          { emoji: '🎮', text: 'Sicut ludus cui interdum me iungo', subtext: 'Like a game I join in now and then', points: 3 },
          { emoji: '🎢', text: 'Sicut explicans adventura cuius pars plena sum', subtext: 'Like an unfolding adventure I am fully part of', points: 4 },
        ],
      },
    ],
  },
...
export default function LatinQuizPage() {
  ...
  useEffect(() => {
    localStorage.removeItem('latinQuizAnswers');
    localStorage.removeItem('latinQuizCurrentPage');
    localStorage.removeItem('latinUserForm');
    localStorage.removeItem('latinTotalScore');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <footer className="sticky bottom-0 left-0 right-0 bg-white border-t px-6 py-4 flex gap-3 mt-6">
        ...
        >
          {currentPage === totalPages ? 'Proximus' : 'Proximus'}
        </button>
      </footer>
    </div>
  );
