    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🧩', text: 'Eine Geschichte, die ständig ihre Handlung verliert', subtext: 'A story that keeps losing its plot', points: 2 },
          { emoji: '📝', text: 'Ein Entwurf mit vielen ausstehenden Bearbeitungen', subtext: 'A rough draft with many edits pending', points: 1 },
          { emoji: '🎬', text: 'Ein Drehbuch, das größtenteils auf Kurs ist', subtext: 'A script that is mostly on track', points: 3 },
          { emoji: '📖', text: 'Eine Erzählung, die sich so entfaltet, wie sie sollte', subtext: 'A narrative unfolding the way it should', points: 5 },
        ],
      },
      {
        id: 'q2',
        ...
        options: [
          { emoji: '🥤', text: 'Wie eine geschüttelte Limonadendose', subtext: 'Like a shaken soda can', points: 0 },
          { emoji: '🏠', text: 'Wie ein Raum, der unordentlich wird und dann zurückgesetzt wird', subtext: 'Like a room that gets messy and then reset', points: 1 },
          { emoji: '💧', text: 'Wie ein Teich mit seltenen Wellen', subtext: 'Like a pond with rare ripples', points: 2 },
          { emoji: '🌊', text: 'Wie ein tiefer See, innerlich meist still', subtext: 'Like a deep lake, mostly still inside', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🤖', text: 'Auf Autopilot, gehe nur durch Bewegungen', subtext: 'On autopilot, just going through motions', points: 0 },
          { emoji: '🌫️', text: 'Mit einer vagen Vorstellung, was zu tun ist', subtext: 'With a vague idea of what to do', points: 1 },
          { emoji: '🗺️', text: 'Mit einem lockeren Spielplan im Kopf', subtext: 'With a loose game plan in mind', points: 3 },
          { emoji: '🧭', text: 'Mit einem klaren inneren Kompass für den Tag', subtext: 'With a clear inner compass for the day', points: 4 },
        ],
      },
      {
        id: 'q4',
        ...
        options: [
          { emoji: '🏚️', text: 'Wie in einem Haus zu leben, das ich nie gewählt habe', subtext: 'Like living in a house I never chose', points: 0 },
          { emoji: '🏠', text: 'Wie ein Haus mit ein paar richtigen Räumen', subtext: 'Like a house with a few right rooms', points: 2 },
          { emoji: '🏡', text: 'Wie das Zuhause, das ich mir grob vorgestellt hatte', subtext: 'Like the home I had roughly imagined', points: 1 },
          { emoji: '🖼️', text: 'Wie in das Leben zu gehen, das ich einst auf Papier gezeichnet habe', subtext: 'Like walking inside the life I once drew on paper', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '📢', text: 'Meist wie Hintergrundkritik', subtext: 'Mostly like background criticism', points: 0 },
          { emoji: '⚖️', text: 'Eine Mischung aus Zweifeln und kleinen Aufmunterungen', subtext: 'A mix of doubts and small pep talks', points: 1 },
          { emoji: '🧠', text: 'Oft wie ein unterstützender innerer Coach', subtext: 'Often like a supportive inner coach', points: 3 },
          { emoji: '📣', text: 'Weitgehend wie ein stetiges inneres Cheerleader-Team', subtext: 'Largely like a steady inner cheer squad', points: 4 },
        ],
      },
      {
        id: 'q6',
        ...
        options: [
          { emoji: '☁️', text: 'Fast nie, die meisten Tage fühlen sich flach an', subtext: 'Almost never, most days feel flat', points: 0 },
          { emoji: '⚡', text: 'Kleine Funken tauchen ab und zu auf', subtext: 'Small sparks show up once in a while', points: 1 },
          { emoji: '🕯️', text: 'An vielen Tagen ist ein sanftes Leuchten vorhanden', subtext: 'A gentle glow is present on many days', points: 2 },
          { emoji: '🔥', text: 'Häufige Ausbrüche, die mich zum Handeln bewegen', subtext: 'Frequent bursts that move me to act', points: 3 },
          { emoji: '☀️', text: 'Ein stetiges inneres Feuer, das mich am Schaffen hält', subtext: 'A steady inner fire that keeps me creating', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '💥', text: 'Ich breche emotional zusammen, wenn sich Pläne ändern', subtext: 'I crash emotionally when plans change', points: 0 },
          { emoji: '😰', text: 'Ich werde stark erschüttert und bleibe aufgewühlt', subtext: 'I get badly shaken and stay upset', points: 1 },
          { emoji: '🌀', text: 'Ich wackle, aber gewinne das Gleichgewicht zurück', subtext: 'I wobble but regain balance', points: 3 },
          { emoji: '🧘', text: 'Ich passe mich mit leichtem Unbehagen an', subtext: 'I adjust with mild discomfort', points: 2 },
          { emoji: '🎯', text: 'Ich bleibe zentriert und plane einfach neu', subtext: 'I stay centred and simply re-route', points: 4 },
        ],
      },
      {
        id: 'q8',
        ...
        options: [
          { emoji: '🔇', text: 'Meist stumm geschaltet, Geist ist woanders', subtext: 'Mostly on mute, mind is elsewhere', points: 0 },
          { emoji: '↔️', text: 'Halb hier, halb beim nächsten Ding', subtext: 'Half here, half on the next thing', points: 1 },
          { emoji: '👁️', text: 'Allgemein präsent mit ein paar Aussetzern', subtext: 'Generally present with a few slips', points: 2 },
          { emoji: '⏰', text: 'Vertieft genug, um die Zeit zu verlieren', subtext: 'Immersed enough to lose track of time', points: 3 },
          { emoji: '✨', text: 'Tief versunken, das Leben fühlt sich lebendig an', subtext: 'Deeply absorbed, life feels vivid', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌑', text: 'Ein Korridor mit ausgeschalteten Lichtern', subtext: 'A corridor with lights switched off', points: 0 },
          { emoji: '🌫️', text: 'Eine neblige Gasse mit schwachen Umrissen', subtext: 'A foggy lane with faint outlines', points: 1 },
          { emoji: '🛣️', text: 'Eine kurvenreiche Straße mit Lampen in Abständen', subtext: 'A winding road with lamps at intervals', points: 2 },
          { emoji: '🛤️', text: 'Eine offene Autobahn mit klaren Schildern', subtext: 'An open highway with clear signboards', points: 3 },
          { emoji: '🌅', text: 'Ein weiter Horizont mit vielen hellen Wegen', subtext: 'A wide horizon with many bright paths', points: 4 },
        ],
      },
      {
        id: 'q10',
        ...
        options: [
          { emoji: '📉', text: 'Meist emotionale Verluste oder Erschöpfung', subtext: 'Mostly emotional losses or drains', points: 0 },
          { emoji: '💫', text: 'Ein paar verstreute Momente der Rückkehr', subtext: 'A few scattered moments of return', points: 2 },
          { emoji: '⚖️', text: 'Ein fairer Anteil an Freude und Erfüllung', subtext: 'A fair share of joy and fulfilment', points: 1 },
          { emoji: '📈', text: 'Beständige Erträge, die sich lohnen', subtext: 'Consistent returns that feel worth the effort', points: 3 },
          { emoji: '💎', text: 'Reiche emotionale Dividenden in den meisten Bereichen', subtext: 'Rich emotional dividends in most areas', points: 4 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🔄', text: 'Ich fühle mich auf Wiederholung festgefahren', subtext: 'I feel stuck on repeat', points: 0 },
          { emoji: '📊', text: 'Ich wachse nur in kleinen, seltenen Sprüngen', subtext: 'I grow only in small, rare jumps', points: 1 },
          { emoji: '🌱', text: 'Ich kann stetiges inneres Wachstum spüren', subtext: 'I can sense steady inner growth', points: 3 },
          { emoji: '🌳', text: 'Ich entwickle mich auf bemerkenswerte Weise weiter', subtext: 'I keep evolving in noticeable ways', points: 4 },
        ],
      },
      {
        id: 'q12',
        ...
        options: [
          { emoji: '🚨', text: 'Meist treiben mich Überleben und Dringlichkeit an', subtext: 'Mostly survival and urgency drive me', points: 0 },
          { emoji: '🤔', text: 'Manchmal überprüfe ich, ob es wirklich wichtig ist', subtext: 'Sometimes I check if it truly matters', points: 2 },
          { emoji: '🧭', text: 'Oft überprüfe ich die Ausrichtung mit meinem Warum', subtext: 'Often I check alignment with my why', points: 1 },
          { emoji: '⭐', text: 'Weitgehend folgen meine Entscheidungen einem klaren inneren Zweck', subtext: 'Largely my choices follow a clear inner purpose', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🎭', text: 'Ich trage oft Masken, um durchzukommen', subtext: 'I often wear masks to get through', points: 0 },
          { emoji: '👥', text: 'Ich kann nur bei wenigen Menschen ich selbst sein', subtext: 'I can be myself only with a few people', points: 1 },
          { emoji: '😊', text: 'Ich bin in den meisten Räumen meist ich selbst', subtext: 'I am mostly myself in most spaces', points: 3 },
          { emoji: '💯', text: 'Ich fühle mich fast überall in meiner Haut zu Hause', subtext: 'I feel at home in my own skin almost everywhere', points: 4 },
        ],
      },
      {
        id: 'q14',
        ...
        options: [
          { emoji: '🚫', text: 'Ich vermeide es, allein mit mir selbst zu sein', subtext: 'I avoid being alone with myself', points: 0 },
          { emoji: '⏱️', text: 'Ich toleriere meine eigene Gesellschaft in kleinen Dosen', subtext: 'I tolerate my own company in small doses', points: 1 },
          { emoji: '👍', text: 'Ich verbringe im Allgemeinen gerne Zeit mit mir selbst', subtext: 'I generally like spending time with myself', points: 2 },
          { emoji: '💖', text: 'Ich freue mich wirklich auf meine Alleinzeit', subtext: 'I genuinely look forward to my alone time', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🚧', text: 'Menschen zögern, sich mir zu öffnen', subtext: 'People hesitate to open up to me', points: 0 },
          { emoji: '🤐', text: 'Einige teilen, aber vorsichtig', subtext: 'A few share, but cautiously', points: 1 },
          { emoji: '🤗', text: 'Viele Menschen vertrauen mir leicht', subtext: 'Many people confide in me with ease', points: 3 },
          { emoji: '🛡️', text: 'Ich bin oft die Person, an die sich Menschen zuerst wenden', subtext: 'I am often the person people turn to first', points: 4 },
        ],
      },
      {
        id: 'q16',
        ...
        options: [
          { emoji: '😶', text: 'Ich habe Schwierigkeiten, mich an etwas Angenehmes zu erinnern', subtext: 'I struggle to recall anything pleasant', points: 0 },
          { emoji: '🌟', text: 'Ein paar verstreute gute Momente tauchen auf', subtext: 'A few scattered good moments come up', points: 1 },
          { emoji: '😌', text: 'Mehrere warme Erinnerungen tauchen leicht auf', subtext: 'Several warm memories surface easily', points: 2 },
          { emoji: '🌈', text: 'Viele lebendige angenehme Momente kommen gleichzeitig in den Sinn', subtext: 'Many vivid pleasant moments come to mind at once', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '🌪️', text: 'Meine Stimmungen sind unabhängig vom Schlaf instabil', subtext: 'My moods are unstable regardless of sleep', points: 0 },
          { emoji: '🤷', text: 'Schlaf hilft ein wenig, aber nicht zuverlässig', subtext: 'Sleep helps a little but not reliably', points: 1 },
          { emoji: '😴', text: 'Guter Schlaf hält mich normalerweise stabiler', subtext: 'Good sleep usually keeps me steadier', points: 2 },
          { emoji: '⚓', text: 'Guter Schlaf verankert eindeutig meine emotionale Balance', subtext: 'Good sleep clearly anchors my emotional balance', points: 3 },
        ],
      },
      {
        id: 'q18',
        ...
        options: [
          { emoji: '📉', text: 'Energie fällt im Laufe des Tages stark ab', subtext: 'Energy drops sharply through the day', points: 0 },
          { emoji: '📊', text: 'Mein Energiegraph ist ein kontinuierliches Zickzack', subtext: 'My energy graph is a continuous zigzag', points: 1 },
          { emoji: '➖', text: 'Energie ist meist stabil mit leichten Einbrüchen', subtext: 'Energy is mostly steady with mild dips', points: 2 },
          { emoji: '🔋', text: 'Ich fühle mich den größten Teil des Tages nachhaltig energiegeladen', subtext: 'I feel sustainably energised most of the day', points: 3 },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: [
          { emoji: '⛓️', text: 'Meist erschöpfende oder trennende Interaktionen', subtext: 'Mostly draining or disconnecting interactions', points: 0 },
          { emoji: '😐', text: 'Neutrale Austausche ohne viel Gefühl', subtext: 'Neutral exchanges without much feeling', points: 1 },
          { emoji: '🤝', text: 'Allgemein warme und verbindende Momente', subtext: 'Generally warm and connecting moments', points: 2 },
          { emoji: '💞', text: 'Tiefe, nährende Verbindungen in vielen Interaktionen', subtext: 'Deep, nourishing connections in many interactions', points: 3 },
        ],
      },
      {
        id: 'q20',
        ...
        options: [
          { emoji: '🖼️', text: 'Wie Hintergrundtapete, die ich kaum bemerke', subtext: 'Like background wallpaper I hardly notice', points: 0 },
          { emoji: '🎬', text: 'Wie ein Film, den ich von der Seitenlinie aus beobachte', subtext: 'Like a movie I watch from the side-lines', points: 1 },
          { emoji: '🎮', text: 'Wie ein Spiel, an dem ich ab und zu teilnehme', subtext: 'Like a game I join in now and then', points: 3 },
          { emoji: '🎢', text: 'Wie ein sich entfaltendes Abenteuer, an dem ich voll teilhabe', subtext: 'Like an unfolding adventure I am fully part of', points: 4 },
        ],
      },
    ],
  },
...
export default function GermanQuizPage() {
  ...
  useEffect(() => {
    ...
    localStorage.removeItem('germanUserForm');
    localStorage.removeItem('germanTotalScore');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <footer className="sticky bottom-0 left-0 right-0 bg-white border-t px-6 py-4 flex gap-3 mt-6">
        ...
        >
          {currentPage === totalPages ? 'Weiter' : 'Weiter'}
        </button>
      </footer>
    </div>
  );
